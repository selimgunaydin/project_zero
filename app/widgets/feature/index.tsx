            ...
            <div className={data.content.textContent.className}>
              ...
              <dl className={data.content.featureList.className}>
                {data.content.featureList.items.map((feature: any) => (
                  <div key={feature.name} className={feature.container.className}>
                    <dt className={feature.title.className}>
                      
                      {feature.name}
                    </dt>
                    <dd className={feature.description.className}>{feature.description.text}</dd>
                  </div>
                ))}
              </dl>
            </div>
